...
{
    console.log("ipc_meta_errorCheck\n");
    console.log(ipc.meta.sprite);
    console.log(ipc.meta.card);
    if(ipc.meta.sprite == null)
    {
        ipc.meta.sprite = await IPCGif.ipcgif_store(ipc);
    }

    if(ipc.meta.card == null)
    {
        ipc.meta.card = await IPCCard.ipccard_store(ipc);
    }
}
...
const IPCDBLib = {
    ...
    ipc_meta_errorCheck: ipc_meta_errorCheck,
